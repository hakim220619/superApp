...
const createBangunan = async (data) => {
    ...
    const paramsInsert = [
        data.nama_bangunan, data.foto_depan, data.foto_sisi_kiri, data.foto_sisi_kanan, data.judul_foto, data.foto_lainnya,
        data.bentuk_bangunan, data.grade_gudang, data.jumlah_lantai, data.basement, data.konstruksi_bangunan,
        data.konstruksi_lantai, data.konstruksi_dinding, data.konstruksi_atap, data.konstruksi_pondasi, data.versi_btb,
        data.tipe_spek, data.canvas_data, data.jenis_bangunan, data.jenis_bangunan_detail, data.jenis_bangunan_indeks_lantai,
        data.tahun_dibangun, data.keterangan_tahun_dibangun, data.tahun_renovasi, data.keterangan_tahun_direnovasi,
        data.jenis_renovasi, data.bobot_renovasi, data.kondisi_visual, data.catatan_khusus, data.luas_bangunan_terpotong,
        data.luas_bangunan_imb, data.luas_nama_pintu_jendela, data.luas_bobot_pintu_jendela, data.luas_nama_dinding,
        data.luas_bobot_dinding, data.luas_nama_rangka_atap_datar, data.luas_bobot_rangka_atap_datar,
        data.luas_nama_atap_datar, data.luas_bobot_atap_datar, data.tipe_pondasi_existing,
        data.bobot_tipe_pondasi_existing, data.tipe_struktur_existing, data.bobot_tipe_struktur_existing,
        data.tipe_rangka_atap_existing, data.bobot_rangka_atap_existing, data.tipe_penutup_atap_existing,
        data.bobot_penutup_atap_existing, data.tipe_tipe_dinding_existing, data.bobot_tipe_dinding_existing,
        data.tipe_tipe_pelapis_dinding_existing, data.bobot_tipe_pelapis_dinding_existing,
        data.tipe_tipe_pintu_jendela_existing, data.bobot_tipe_pintu_jendela_existing,
        data.tipe_tipe_lantai_existing, data.bobot_tipe_lantai_existing, data.jumlah_lantai_rumah_tinggal,
        data.penggunaan_bangunan, data.perlengkapan_bangunan, data.progres_pembangunan, data.kondisi_bangunan,
        data.status_data
    ];
